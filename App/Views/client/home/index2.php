...
<div id="heroDiv" style="padding-top: 70px;background-color: var(--body)!important;" class="row ">
    <div class="col-md-8 mb-0 pb-0">
        <div id="heroCarousel" class="carousel slide mt-3 mx-3" data-bs-ride="carousel">
            ...
            <ol class="carousel-indicators">
                ...
                <li data-bs-target="#heroCarousel" data-bs-slide-to="4" class="active" aria-current="true"></li>
            </ol>
