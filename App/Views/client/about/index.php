...
<div class="container pt-3 pb-3">
    ...
    <h2 class="title text-center" style="color: var(--bs-primary)">TẠI SAO NÊN CHỌN CHÚNG TÔI?</h2>
    <div class="about mt-4">
        <img class="about-logo h-75" src="<?= URL_ICON ?>/fraazo-logo.png" alt="Teo's logo">
        <div class="about-content mt-4">
            <h2 class="about-content-title">Xin chào! Mình tên là Fazzo</h2>
            <p>“Fazzo store” là cửa hàng chuyên cung cấp các loại sau sạch trên địa bàn Thành phố Cần Thơ. Rau được trồng theo mô hình nông nghiệp sạch với tiêu chí 4K, cam kết đem lại cho quý khách hàng những sản phẩm rau tươi an toàn cho sức khỏe. Hãy cùng trở thành những người tiêu dùng thông minh khi chọn sử dụng các sản phẩm Fazzo store nhé!</p>
            <a class="btn btn-primary" href="<?= DOCUMENT_ROOT ?>/products">Ghé Fazzo store</a>
        </div>
    </div>
</div>
        ...
        <div class="organic">
            <div class="vege-4k pe-5 ps-5">
                ...
                <div class="vege-4k-content">
                    ...
                    <p class="content-4k">Rau Fazzo store được trồng trong nhà lưới Israel chống côn trùng xâm nhập, giám sát bằng công nghệ 4.0.</p>
                </div>
            </div>
            ...
            <div class="vege-4k ps-5 pe-5">
                ...
                <div class="vege-4k-content">
                    ...
                    <p class="content-4k">Rau Fazzo store được trồng một cách tự nhiên như bạn tự trồng rau tại sân vườn nhà mình.</p>
                </div>
            </div>
            ...
            <div class="vege-4k pe-5 ps-5 vege-4k-mobile">
                <div class="vege-4k-content">
                    ...
                    <p class="content-4k">Rau Fazzo store được đóng gói tại vườn và đến tay khách hàng tuyệt đối không sử dụng chất bảo quản nào.</p>
                </div>
            ...
            <div class="vege-4k ps-5 pe-5 vege-4k-mobile">
                <div class="vege-4k-content">
                    ...
                    <p class="content-4k">Hạt giống sử dụng tại Fazzo store được kiểm soát chặt chẽ nguồn gốc, đơn vị sản xuất, nhập khẩu và phân phối.</p>
                </div>
