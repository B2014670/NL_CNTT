<header>
    <div id="wrapper" class="wrapper position-fixed top-0" style="height: 80px;">
        <div class="container mt-1 mb-2">
            <div class="row d-flex justify-content-center align-items-center">
                <div id="header-logo" class="col-xl-3 col-md-3">
                    <a href="<?= DOCUMENT_ROOT ?>/about"><img class="w-75" src="<?= URL_ICON ?>/fraazo-logo.png" alt="Logo" height="70px"></a>
                </div>
                ...
                <div id="header-search" class="col-xl-3 col-md-7">
                    <div class="form-text">
                        <form action="<?= DOCUMENT_ROOT ?>/products/search" method="get">
                            <input type="text" placeholder="Tìm kiếm..." name="key" id="search" autocomplete="off">
                        </form>
                    </div>
                </div>
                ...
                <div id="btn-menu-mobile" class="header__menu-mobile col-xs-1 col-md-1 d-flex justify-content-end">
