        ...
        <div class="card-body p-4 p-sm-5">
          ...
          <form action="<?= DOCUMENT_ROOT ?>/accounts/passwordReset" method="POST">
            ...
            <div class="form-floating mb-3">
              <input value="<?= $data['email'] ?>" name="email" type="text" class="form-control" id="floatingInputEmail" placeholder="name@example.com"  required style="border: 1px solid #ced4da"> <!-- onblur="checkEmailSentToken(this.value)" -->
            ...
            <div class="d-grid mb-2">
              <button class="btn btn-lg btn-primary btn-login btn-sentMail fw-bold text-uppercase">Gửi lại</button>
            </div>
